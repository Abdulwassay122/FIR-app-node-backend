...
const FIR = sequelize.define("FIR", {
  fir_id: { type: DataTypes.INTEGER, autoIncrement: true, primaryKey: true },
  complainant_id: { type: DataTypes.INTEGER, references: { model: Complainant, key: "complainant_id" } },
  officer_id: { type: DataTypes.INTEGER, references: { model: Officer, key: "officer_id" } },
  station_id: { type: DataTypes.INTEGER, references: { model: PoliceStation, key: "station_id" } },
  type_id: { type: DataTypes.INTEGER, references: { model: CrimeType, key: "type_id" } },
